...
4. **Semantics (Agents Write, Humans Review):** You don't review a 400-line diff of `+` and `-` symbols. You review the **Intent Log**. You see: *"Intent: Refactoring Auth"* ➔ Linked to 12 Splice Operations. **Agents do the writing; humans review the reasoning.**
